...
export interface ApiActualiteeActualitee extends Struct.CollectionTypeSchema {
  collectionName: 'actualitees';
  info: {
    displayName: 'Actualitee';
    pluralName: 'actualitees';
    singularName: 'actualitee';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::actualitee.actualitee'
    > &
      Schema.Attribute.Private;
    nom_bouton: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMembreMembre extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    lien_projet: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::membre.membre'
...
export interface ApiNousNous extends Struct.SingleTypeSchema {
  collectionName: 'nouss';
  info: {
    displayName: 'Nous';
    pluralName: 'nouss';
    singularName: 'nous';
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::nous.nous'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiProjetProjet extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    caracteristiques: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    lien: Schema.Attribute.String;
    lien_nom: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::projet.projet'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::actualitee.actualitee': ApiActualiteeActualitee;
      'api::membre.membre': ApiMembreMembre;
      'api::nous.nous': ApiNousNous;
